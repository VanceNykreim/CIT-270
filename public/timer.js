//© 2021 Sean Murdock
    ...
    $(document).ready(function(){
        ...
        const cookies = document.cookie; //make a reference to your current cookie
        ...
        console.log("cookieValue", JSON.stringify(cookieValue)); //paste a xookie
        if (cookieValue == null) {
            window.location="/"; //there is no login token, so they must not have logged in yet, we will help redirect them here
        } else {
